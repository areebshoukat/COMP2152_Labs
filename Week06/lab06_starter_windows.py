...
#
#  TASKS COMPLETED:
#   - Task 1: write_to_log(), read_log()
#   - Task 2: log_to_csv(), read_csv_log()
#   - Task 3: safe_read_log()
#
# ============================================================
...
def write_to_log(filename, entry):
    ...
    # Open the file in append mode ("a") and write entry + "\n"
...
def read_log(filename):
    ...
    # Open the file in read mode ("r") and return file.read()
